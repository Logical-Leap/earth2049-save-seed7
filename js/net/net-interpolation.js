...
(function (global) {
  ...
  class SnapshotBuffer {
    ...
    push(s) { this.items.push(Object.assign({ at: performance.now() }, s)); if (this.items.length > 8) this.items.shift(); }
    ...
    sample() {
      ...
      const span = Math.max(1, b.at - a.at), t = (target - a.at) / span;
      return {
        x: lerp(a.x, b.x, t), y: lerp(a.y || 0, b.y || 0, t), z: lerp(a.z, b.z, t),
        yaw: lerpAngle(a.yaw || 0, b.yaw || 0, t), hp: b.hp, armor: b.armor, state: b.state || 'alive', name: b.name, color: b.color
      };
    }
  }
